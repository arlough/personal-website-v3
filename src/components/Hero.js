...
export default function Hero(){
    return (
        <div className="justify-between  space-x-10 text-white h-[60vh] flex ml-20 mr-20 mt-24">
            {/* Hero container div */}
            <div className="flex flex-col justify-between flex-grow w-2/5 px-8 py-8 space-y-8 border rounded-3xl bg-primary">
                {/* Left side */}
            ...
            <div className="items-center w-2/5 border border-blue-500 ">
                {/* RIght side - image */}
                <img
                src={profile}
                />
