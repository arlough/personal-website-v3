        ...
        <section className="flex flex-col-reverse self-center justify-between h-auto ml-20 mr-20 overflow-hidden text-white md:max-w-5xl lg:space-x-10 lg:flex-row">
            ...
            <div id="hero" className="flex flex-col justify-between flex-grow w-auto px-8 py-8 space-y-8 border lg:w-1/5 rounded-3xl bg-primary">
                ...
                <div className="flex self-center my-auto space-x-8 text-4xl text-white h-1/4">
                    ...
                    <svg className="transition duration-300 fill-white hover:fill-hover" xmlns="http://www.w3.org/2000/svg" width="48" height="48" 
                    viewBox="0 0 24 24">
                    ...
                    <svg className="transition duration-300 fill-white hover:fill-hover" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                    </a>
                    
                    <a href="mailto:loughneyaidan@gmail.com">
                    <svg className="transition duration-300 fill-white text-primary hover:fill-hover" xmlns="http://www.w3.org/2000/svg" width="48" height="48"  viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
